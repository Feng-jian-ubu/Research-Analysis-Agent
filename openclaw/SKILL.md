...
### ④ statisticsexecutor.py — 统计方法执行 & 报告生成
...
# Step 3: 统计分析
python3 statisticsexecutor.py experiment_data_final.csv -m regression -y score -x hours

# Step 4: 生成图表 (含 PNG + HTML)
python3 figuregenerator.py experiment_data_final.csv experiment_data_final_result.json \
    --png -t all -o experiment

# Step 5: 生成报告
python3 reportgenerator.py experiment_data_final_result.json \
    --data experiment_data_final.csv \
    --figure-prefix experiment \
    -o final_report
```
